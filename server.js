...
const PROFESSIONS = [
  ...
  { slug: 'flooring', label: 'Flooring Installers', h1: 'Free Flooring Quote Template', desc: 'Flooring quote generator. Quote for supply and installation. Free PDF download.', intro: 'Quote for flooring installation. Include materials per mÂ², underlay, fitting and waste removal.' },
...
const COUNTRIES = [
  { slug: 'uk', label: 'UK', fullName: 'United Kingdom', currency: 'GBP', symbol: 'Â£', tax: 'VAT', taxRate: 20 },
  ...
  { slug: 'germany', label: 'Germany', fullName: 'Germany', currency: 'EUR', symbol: 'â‚¬', tax: 'MwSt', taxRate: 19 },
  { slug: 'france', label: 'France', fullName: 'France', currency: 'EUR', symbol: 'â‚¬', tax: 'TVA', taxRate: 20 },
  { slug: 'india', label: 'India', fullName: 'India', currency: 'INR', symbol: 'â‚¹', tax: 'GST', taxRate: 18 },
  ...
  { slug: 'netherlands', label: 'Netherlands', fullName: 'Netherlands', currency: 'EUR', symbol: 'â‚¬', tax: 'BTW', taxRate: 21 },
...
// â”€â”€ PDF GENERATION (PDFKit â€” no chromium needed) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

function currencySymbol(code) {
  const map = { USD:'$', GBP:'Â£', EUR:'â‚¬', CAD:'CA$', AUD:'AU$', INR:'â‚¹', AED:'AED ', SGD:'S$', TRY:'â‚º', JPY:'Â¥', CHF:'CHF ', NZD:'NZ$', ZAR:'R', BRL:'R$', MXN:'MX$', SEK:'kr ', NOK:'kr ' };
  ...
  try {
    ...
    if (d.validUntil) {
      ...
      doc.fontSize(9).fillColor('#c53030').font('Helvetica')
        .text('âš   This quotation is valid until ' + d.validUntil + '. Prices may change after this date.', 60, y + 10, { width: 480 });
    }
