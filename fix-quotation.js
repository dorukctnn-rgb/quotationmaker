...
// 2. 3 yeni blog post ekle - free-quote-template-guide'dan sonra
const newBlogs = `,
...
s = s.replace(
  "{ slug: 'free-quote-template-guide', title: 'Free Quote Template: What to Use and How to Customise It'",
  "{ slug: 'free-quote-template-guide', title: 'Free Quote Template: What to Use and How to Customise It'"
);

// Sadece son blog postun kapanışından sonra ekle
s = s.replace(
  /(\{ slug: 'free-quote-template-guide'.*?\})\s*\];(\s*const HOW_TO_PAGES)/s,
  '$1' + newBlogs + '\n];\n$2'
);
